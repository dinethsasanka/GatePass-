...
const ItemSchema = new mongoose.Schema({
    ...
    //status:{ type: String },
    status: { type: String, enum: ["returnable", "non-returnable","return to Sender","return to Petrol Leader","return to Out Location Petrol Leader","return to Executive Officer","returned"], default: "non-returnable" },
});
